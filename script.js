document.addEventListener('DOMContentLoaded', () => {
    ...
    function populateHTML() {
        const whoWeAreData = [
            { icon: 'https://placehold.co/80x80/1c2433/f1f5f9?text=Icon', title: 'About INLIGHN TECH', text: 'We believe that the future of education lies in bridging the gap between academic learning and industry needs.' },
            { icon: 'https://placehold.co/80x80/1c2433/f1f5f9?text=Icon', title: 'Our Mission', text: 'To empower students by providing immersive, real-world learning experiences through tailored internship programs.' },
            { icon: 'https://placehold.co/80x80/1c2433/f1f5f9?text=Icon', title: 'Our Vision', text: 'To equip participants with practical skills and confidence they need to succeed in the fast-evolving tech industry.' }
        ];
        const statsData = [
        ...
        const testimonialsData = [
            { name: 'Surendra Kumar', role: 'Data Science Intern', text: 'I completed my Data Science internship at INLIGHN TECH, gaining hands-on experience in Machine Learning & AI Models. The guidance improved my problem-solving skills.', img: 'https://placehold.co/100x100/1c2433/f1f5f9?text=S.K.' },
            { name: 'Mrunalini R', role: 'Data Analyst Intern', text: 'During my internship, I learned SQL, Power BI, and Tableau. The program focused on real-world business intelligence projects, which helped me understand data-driven decision-making.', img: 'https://placehold.co/100x100/1c2433/f1f5f9?text=M.R.' },
            { name: 'Vignesh', role: 'Business Analyst Intern', text: 'I interned in Business Analysis where I gained experience in Market Research and Financial Analysis. The training and projects provided deep insights into business strategies. Incredibly valuable.', img: 'https://placehold.co/100x100/1c2433/f1f5f9?text=V.' }
        ];
        const footerHTML = `
            <div class="container footer-container">
                <div class="footer-about" data-animation="fade-in-up"><img src="https://placehold.co/150x50/0a111a/f1f5f9?text=Logo" alt="Inlighn Tech"><p>At INLIGHN TECH, we believe that the future of education lies in bridging the gap between academic learning and industry needs.</p></div>
