document.addEventListener('DOMContentLoaded', () => {
    ...
    function populateHTML() {
        const whoWeAreData = [
            { icon: 'https://i.ibb.co/L9B13zD/icon-about.png', title: 'About INLIGHN TECH', text: 'We believe that the future of education lies in bridging the gap between academic learning and industry needs.' },
            { icon: 'https://i.ibb.co/hK5bF1g/icon-mission.png', title: 'Our Mission', text: 'To empower students by providing immersive, real-world learning experiences through tailored internship programs.' },
            { icon: 'https://i.ibb.co/sKkG2z7/icon-vision.png', title: 'Our Vision', text: 'To equip participants with practical skills and confidence they need to succeed in the fast-evolving tech industry.' }
        ];
        const statsData = [
        ...
        const testimonialsData = [
            { name: 'Surendra Kumar', role: 'Data Science Intern', text: 'I completed my Data Science internship at INLIGHN TECH, gaining hands-on experience in Machine Learning & AI Models. The guidance improved my problem-solving skills.', img: 'https://i.ibb.co/xGLKxYw/t1.jpg' },
            { name: 'Mrunalini R', role: 'Data Analyst Intern', text: 'During my internship, I learned SQL, Power BI, and Tableau. The program focused on real-world business intelligence projects, which helped me understand data-driven decision-making.', img: 'https://i.ibb.co/zP0YqjK/t2.jpg' },
            { name: 'Vignesh', role: 'Business Analyst Intern', text: 'I interned in Business Analysis where I gained experience in Market Research and Financial Analysis. The training and projects provided deep insights into business strategies. Incredibly valuable.', img: 'https://i.ibb.co/s51gR2z/t3.jpg' }
        ];
        const footerHTML = `
            <div class="container footer-container">
                <div class="footer-about" data-animation="fade-in-up"><img src="https://i.ibb.co/6rC6hC4/logo.png" alt="Inlighn Tech"><p>At INLIGHN TECH, we believe that the future of education lies in bridging the gap between academic learning and industry needs.</p></div>
